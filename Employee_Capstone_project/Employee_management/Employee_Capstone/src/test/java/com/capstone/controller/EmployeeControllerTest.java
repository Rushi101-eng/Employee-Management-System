...
public class EmployeeControllerTest {
    ...
    public void testGetEmployeeByCode() {
        ...
        ResponseEntity<ApiResponseDto> response = employeeController.getEmployeeByDepartmentCode(1L);
        assertEquals(HttpStatus.OK, response.getStatusCode());
    ...
    public void testGetAllService() {
        ...
        ResponseEntity<AllApiResponnseDto> response = employeeController.getAllServices(1L);
        assertEquals(HttpStatus.OK, response.getStatusCode());
